...
(function (a, b) {
    ...
    var c = function (a) {
        ...
        shivDocument: function (a) {
            ...
            a.documentShived = !0;
            var f = a.createElement, g = a.createDocumentFragment,
                h = a.getElementsByTagName("head")[0], i = function (a) {
                    f(a)
                };
    ...
    a.attachEvent("onbeforeprint", function () {
        ...
        var c = -1, d = new RegExp("^(" + a.html5.elements.join("|") + ")$", "i"),
            e = b.getElementsByTagName("*"), g = e.length, j, k = i(h(function (a, b) {
                var c = [], d = a.length;
